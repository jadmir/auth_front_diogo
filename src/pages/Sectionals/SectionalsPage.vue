...
<script setup>
  ...
  import { SectionalCrudService } from 'src/services/crud/sectional.crud.service'
  import SectionalForm from 'pages/Sectionals/components/SectionalForm.vue'
  import SectionalTable from 'pages/Sectionals/components/SectionalTable.vue'

  const title = 'Seccionales'
  const description = 'Creación y edición de seccionales'
  const newItemLabel = 'Nuevo seccional'
  const service = new SectionalCrudService()
  const initItem = {
    name: '',
    description: '',
  }
