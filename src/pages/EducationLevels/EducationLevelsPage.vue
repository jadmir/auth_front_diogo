...
<script setup>
  ...
  import { EducationLevelCrudService } from 'src/services/crud/educationLevel.crud.service'
  import EducationLevelForm from 'pages/EducationLevels/components/EducationLevelForm.vue'
  import EducationLevelTable from 'pages/EducationLevels/components/EducationLevelTable.vue'

  const title = 'Niveles educativos'
  const description = 'Creación y edición de niveles educativos'
  const newItemLabel = 'Nuevo nivel educativo'
  const service = new EducationLevelCrudService()
  const initItem = {
    name: '',
    description: '',
  }
