...
<script setup>
  ...
  import { ProfessionCrudService } from 'src/services/crud/profession.crud.service'
  import ProfessionTable from 'pages/Professions/components/ProfessionTable.vue'
  import ProfessionForm from 'pages/Professions/components/ProfessionForm.vue'

  const title = 'Profesiones'
  const description = 'Creación y edición de profesiones'
  const newItemLabel = 'Nueva profesion'
  const service = new ProfessionCrudService()
  const initItem = {
    name: '',
    description: '',
  }
