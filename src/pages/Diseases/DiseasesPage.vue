...
<script setup>
  ...
  import DiseaseForm from 'pages/Diseases/components/DiseaseForm.vue'
  import DiseaseTable from 'pages/Diseases/components/DiseaseTable.vue'
  import { DiseaseCrudService } from 'src/services/crud/disease.crud.service'

  const title = 'Enfermedades'
  const description = 'Creación y edición de enfermedades'
  const newItemLabel = 'Nueva enfermedad'
  const service = new DiseaseCrudService()
  const initItem = {
    name: '',
    description: '',
  }
